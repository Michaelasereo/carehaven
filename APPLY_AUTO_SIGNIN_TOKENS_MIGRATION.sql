-- ==============================================
-- AUTO SIGNIN TOKENS TABLE
-- ==============================================
-- Run this SQL in your Supabase SQL Editor to create the auto_signin_tokens table
-- This is required for the session creation fix to work
-- ==============================================
...
DROP POLICY IF EXISTS "Service role only" ON auto_signin_tokens;
...
-- ==============================================
-- After running this, the session creation fix should work for all user roles:
-- - Patients
-- - Doctors
-- - Admins
-- ==============================================
