...
import { createMockAppointment, renderWithAppProviders } from '@/__tests__/utils/test-utils'
...
describe('AppointmentCard', () => {
  ...
  it('displays appointment details correctly', () => {
    renderWithAppProviders(<AppointmentCard appointment={mockAppointment} />)
  ...
  it('hides actions when showActions is false', () => {
    renderWithAppProviders(<AppointmentCard appointment={mockAppointment} showActions={false} />)
